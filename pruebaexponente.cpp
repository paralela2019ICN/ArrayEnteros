...
int exponente_asociado (char polinomio_letras[], int posicion_polinomio_letras,int largo){
    int exponente=0;
    int multiplicador=1;
    while (polinomio_letras[posicion_polinomio_letras+1]!='+' && polinomio_letras[posicion_polinomio_letras+1]!='-'){ 
        posicion_polinomio_letras++;
        if (posicion_polinomio_letras==largo){
            break;
        }
    }
    while (polinomio_letras[posicion_polinomio_letras]!='*'){
        exponente=exponente + (polinomio_letras[posicion_polinomio_letras-1]-48)*multiplicador;
        cout << endl << polinomio_letras[posicion_polinomio_letras-1] << endl;
        multiplicador=multiplicador*10;
        posicion_polinomio_letras--;
        if (polinomio_letras[posicion_polinomio_letras]=='*'){
            break;
        }
    }
    return exponente;
